...
public class AdminSeeder implements ApplicationRunner {
    ...
    public AdminSeeder(
            ...
            @Value("${ooma.admin.email}") String adminEmail,
            @Value("${ooma.admin.password}") String adminPassword,
            @Value("${ooma.admin.name}") String adminName,
            @Value("${ooma.upi-id}") String upiId) {
