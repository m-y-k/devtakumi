...
public class EmailService {
    ...
    public EmailService(
            ...
            @Value("${ooma.mail.from}") String fromAddress,
    ...
    public void sendPasswordResetEmail(String toEmail, String token) {
        ...
        sendOrLog(toEmail, "Reset your OutOfMemoryAcademy password",
    ...
    public void sendSetPasswordEmail(String toEmail, String token) {
        ...
        sendOrLog(toEmail, "Welcome to OutOfMemoryAcademy — set your password",
    ...
    public void sendEnrollmentRejectedEmail(String toEmail, String note) {
        ...
        sendOrLog(toEmail, "OutOfMemoryAcademy enrollment update", body);
    }
