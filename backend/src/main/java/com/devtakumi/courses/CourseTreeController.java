...
import com.devtakumi.courses.dto.*;
...
public class CourseTreeController {
    ...
    public record ClassTreeDto(UUID id, int globalClassNumber, String title, com.devtakumi.courses.ClassDay day, int orderIndex) {}
}
